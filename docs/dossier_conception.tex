	...
	\subsection{Pages publics}
		\subsubsection{Page accueil}
			...
			\begin{paragraphe}
				...
				\end{itemize}
				Les mêmes fonctions est utilisées lors d'un clic sur la photo d'un nouvel artiste : getArtiste(nomArtiste) et lors d'un clic d'un album sorti cette semaine : getAlbum(nomAlbum).
			\end{paragraphe}
